...
export default function CheckoutStatusPage() {
  ...
  const { getPaymentStatusInfo } = useOrderFormatters()
  ...
  useOrderPolling(orderId, order?.payment_status || null)
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card>
            <CardContent className="p-8 text-center">
              <div className="mb-6">
                <paymentInfo.icon className="h-16 w-16 text-blue-600 mx-auto mb-4" />
                <h1 className="text-3xl font-bold text-blue-800 mb-2">
                  Status do Pedido
                </h1>
                <p className="text-muted-foreground">
                  Pedido #{order.id.slice(-8)} • {paymentInfo.description}
                </p>
              </div>
